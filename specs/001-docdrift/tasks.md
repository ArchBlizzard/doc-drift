...
- [x] **T041** Opus-vs-Sonnet ablation: full 12-case agent sweep with `--model opus` into `runs_opus/`, scored with the same harness → `results/ablation_opus.md`; CHANGELOG/README references updated.
